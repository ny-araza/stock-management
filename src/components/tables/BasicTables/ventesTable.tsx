...
export default function VentesTable() {
  ...
  const fetchVentes = async (pageNumber = page, keyword = search) => {
    try {
      setLoading(true);
  ...
  function codeColor(isValide: boolean, isPaye: boolean): string {
        ...
        <div className="max-w-full overflow-x-auto">
          <Table>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {ventes.map((vente) => (
                <TableRow key={vente.vte_id}>
                  <TableCell className={codeColor(vente.vte_valide, vente.vte_paye)}>
                    {vente.vte_code}
                  </TableCell>
                    ...
                    <div className="flex items-center gap-3">
                      <div>
                        ...
                        <span className="block text-gray-500 text-theme-xs dark:text-gray-400">
                          {vente.vte_cli_contact}
                        </span>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.ve_adresse_liv}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {formatDate(vente.vte_datecre)}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {formatDate(vente.vte_datemd)}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_usercre}
                  </TableCell>
                  ...
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_valide ? "validé" : "pas encore validé"}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {formatDate(vente.vte_datevalide)}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_paye ? "payé" : "pas encore payé"}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {formatDate(vente.vte_datepay)}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_modepaye}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_payeclient}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_montant_ht}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_montant_ttc}
                  </TableCell>
                  <TableCell className="px-4 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    {vente.vte_livreur}
                  </TableCell>
